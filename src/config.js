...
export const adminEmail = process.env.ADMIN_EMAIL || 'serzh.shatohin@bk.ru';
...
export const databaseConfig = {
  ...
  host: process.env.DATABASE_DIALECT || 'mysql'
};
...
export const sms = {
  twilio: {
    accountSid: `${process.env.TWILIO_ACCOUNTSID}` || 'ACcd400137b32ab6a7243cc324929c51fd',
    authToken: `${process.env.TWILIO_AUTHTOKEN}` || '599880fe92a1e012e74b7f1ceb036fe0',
    phoneNumber: `${process.env.TWILIO_PHONENUMBER}` || '+15103984916'
  }
};
